...
export declare namespace Message {
    ...
    interface ResponseBase extends Message {
        tts: boolean;
        type: number;
        flags: number;
        pinned: boolean;
...
export type CreateGuildRoleParams = Partial<Pick<Role, 'name' | 'color' | 'hoist'>>;
...
export type CreateGuildParams = Pick<Channel, 'name' | 'type' | 'sub_type' | 'position' | 'parent_id' | 'private_type' | 'speak_permission' | 'application_id'> & {
    private_user_ids: string[];
};
export type ModifyGuildParams = Pick<Channel, 'name' | 'position' | 'parent_id' | 'private_type' | 'speak_permission'>;
...
export declare enum ChannelPrivateType {
    /** 公开频道 */
    PUBLIC = 0,
    /** 群主管理员可见 */
    ADMIN_ONLY = 1,
...
export declare enum ChannelSpeakPermission {
    /** 无效类型 */
    INVALID = 0,
    /** 所有人 */
    ALL = 1,
...
export declare enum AnnounceType {
    MEMBER = 0,
    WELCOME = 1
}
/** 推荐子频道对象 */
 ...
 * 日程提醒类型
 */
export declare enum RemindType {
    /** 不提醒 */
    NEVER = "0",
    /** 开始时提醒 */
    START = "1",
...
export declare enum DeleteHistoryMsgDays {
    ALL = -1,
    NONE = 0,
    DAY_3 = 3,
    DAY_7 = 7,
