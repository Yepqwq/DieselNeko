import{send as k0,Binary as n0,message as W,store as I,useConfig as d0,pick as a0,router as x0,icons as E,Schema as S}from"@koishijs/client";import{defineComponent as f0,reactive as o0,computed as k,watchEffect as s0,watch as Z,ref as P,resolveComponent as v,resolveDirective as $0,withDirectives as z0,openBlock as f,createElementBlock as w,createElementVNode as h,toDisplayString as F,unref as J,createVNode as _,withCtx as p,createTextVNode as U,Fragment as S0,renderList as V0,createBlock as R,withModifiers as e0,resolveDynamicComponent as l0,mergeProps as r0,nextTick as M0,createCommentVNode as L0,KeepAlive as D0,createStaticVNode as O0}from"vue";import{useRoute as R0}from"vue-router";function j0(n){return n0.is(n)?`"b${n.byteLength}"`:n instanceof Date?`"d${n.toJSON()}"`:JSON.stringify(n,(l,t)=>{if(n0.is(t))return`b${t.byteLength}`;if(typeof t=="string")return"s"+t;if(typeof t=="object"){if(t instanceof Date)return"d"+new Date(t).toJSON();if(t===null)return null;const y=Array.isArray(t)?[]:{};for(const u in t)t[u]instanceof Date?(y[u]=new Date(t[u]),y[u].toJSON=void 0):y[u]=t[u];return y}return t})}function B0(n){if(n!==void 0)return JSON.parse(n,(l,t)=>typeof t=="string"?t[0]==="s"?t.slice(1):t[0]==="b"?+t.slice(1):new Date(t.slice(1)):t)}async function H(n,...l){return B0(await k0(`database/${n}`,...l.map(j0)))}function g0(n){const l=["B","KB","MB","GB"];for(const t in l)if(t&&n>1024)n/=1024;else return`${+n.toFixed(1)} ${l[t]}`;return`${+n.toFixed(1)} ${l[l.length-1]}`}function c0(n,l=""){return console.warn(n),l.length&&(l+="："),n instanceof Error?l+=n.name:typeof n=="string"&&(l+=n.split(`
`)[0]),W.error(l)}function A(n){return n.toString().padStart(2,"0")}function i0(n){return[A(n.getHours()),A(n.getMinutes()),A(n.getSeconds())].join(":")}function u0(n){return[A(n.getFullYear()),A(n.getMonth()+1),A(n.getDate())].join("-")}const T0={class:"content-right"},I0={class:"header"},F0={class:"table-title"},J0={class:"operations"},U0={key:0},A0={key:1},E0=["onParentDblclick"],N0=f0({__name:"data-table",props:{name:{},filter:{type:Boolean},color:{type:Boolean}},setup(n,{expose:l}){const t=o0({loading:true,pageSize:void 0,offset:0,sort:null,changes:{},newRow:{}}),y=[30,50,100,150,200,500,1e3],u=n,i=k(()=>I.database.tables[u.name]);s0(()=>{t.pageSize=t.pageSize||y[0]}),Z(()=>t.pageSize,c=>{t.offset=Math.floor(t.offset/c)*c},{}),Z(()=>i.value.fields,c=>{for(const e in i.value.fields)e in t.newRow||(t.newRow[e]="")},{immediate:true});const N=P([]);Z(()=>N.value.length,c=>{c&&N.value[c-1].focus()});const V=P([]);async function L(){if(!u.name)return;t.loading=true;const c=t.sort&&{[t.sort.field]:{ascending:"asc",descending:"desc"}[t.sort.order]},e={offset:t.offset,limit:t.pageSize,sort:c};try{const a=u.filter?Object.keys(t.newRow).reduce((s,o)=>(t.newRow[o]&&(s[o]=t.newRow[o],s[o]=B(o,s[o])),s),{}):{};V.value=await H("get",u.name,a,e)}catch{}await M0(),t.loading=false}s0(L);const D=d0(),G=k(()=>p0(D.value));function Q({column:c}){var e,a,s,o;if(!u.color)return c.cellStyle=void 0;if(c.cellStyle)return c.cellStyle;for(const r of((e=G.value.dataview)==null?void 0:e.colors)??[])if(!(!r||!r.types)&&r.types.includes((o=(s=(a=i.value)==null?void 0:a.fields)==null?void 0:s[c.label])==null?void 0:o.deftype))return c.cellStyle={"background-color":r.color};return c.cellStyle={}}l({sendQuery:H,updateData:L});const g=k({get:()=>Math.floor(t.offset/t.pageSize)+1,set:c=>t.offset=(c-1)*t.pageSize}),m=k(()=>{var e;const c={};for(const a in t.changes||{})for(const s in t.changes[a]){const o=M.value[s];(e=o.attrs)!=null&&e.validate&&!o.attrs.validate(t.changes[a][s].model)||(c[a]||(c[a]={}),c[a][s]=t.changes[a][s])}return c}),x=k(()=>!!Object.keys(t.changes||{}).length),Y=k(()=>!!Object.keys(m.value||{}).length),X=k(()=>{var c;for(const e in i.value.fields){const a=M.value[e];if((c=a.attrs)!=null&&c.validate&&!a.attrs.validate(t.newRow[e]))return console.log(e),false}return true}),M=k(()=>Object.keys(i.value.fields).reduce((c,e)=>{const a=i.value.fields[e],s={clearable:false};let o,r;switch(a.deftype){case"time":return{...c,[e]:{is:"el-time-picker",attrs:s}};case"date":return{...c,[e]:{is:"el-date-picker",attrs:{...s,type:"date"}}};case"timestamp":return{...c,[e]:{is:"el-date-picker",attrs:{...s,type:"datetime"}}};case"integer":case"unsigned":r=1;case"float":case"double":case"decimal":o="number";break;default:o="text";break}const z=C=>{if(a.nullable===false&&!C.length)return false;switch(o.value==="number"&&(C=parseFloat(C)),a.deftype){case"unsigned":if(C<0)return false;case"integer":if(C%1!=0)return false;break;case"json":if(C==="")return true;if(!C.startsWith("{")||!C.endsWith("}"))return false;break}return true};return c[e]={is:"el-input",attrs:{type:o,validate:z,step:r}},c},{}));function t0(c){c.order===null?t.sort=null:t.sort={field:c.prop,order:c.order}}function $(c,{row:e,column:a,$index:s}){const o=i.value.fields[c].deftype,r=e[c];switch(o){case"json":return JSON.stringify(r);case"date":if(r instanceof Date)return u0(r);break;case"time":if(r instanceof Date)return i0(r);break;case"timestamp":if(r instanceof Date)return`${u0(r)} ${i0(r)}`;break;case"binary":return`<Binary len=${r}>`}return r}function q(c,e){switch(i.value.fields[c].deftype){case"list":case"json":return JSON.stringify(e);case"time":if(typeof e!="string")return e;const[s,o,r]=e.split(":"),z=new Date;return z.setHours(parseInt(s),parseInt(o),parseInt(r)),z}return e}function B(c,e){switch(i.value.fields[c].deftype){case"unsigned":case"integer":case"float":case"double":return+e;case"boolean":case"list":case"json":return JSON.parse(e)}return e}function T({row:c,column:e,$index:a},s=true){var o,r,z,C;return((r=(o=t.changes)==null?void 0:o[a])==null?void 0:r[e.label])===void 0?false:s?((C=(z=t.changes)==null?void 0:z[c.id])==null?void 0:C[e.label].model.value)!==c[e.label]:true}function K(c,e,a){var s;(s=a.querySelector(".inner-cell"))==null||s.dispatchEvent(new Event("parent-dblclick"))}function _0({row:c,column:e,$index:a}){T({row:c,column:e,$index:a},false)||i.value.fields[e.label].deftype!=="binary"&&(t.changes[a]===void 0&&(t.changes[a]={}),t.changes[a][e.label]=o0({model:q(e.label,c[e.label])}))}function m0({column:c,$index:e}){delete t.changes[e][c.label],Object.keys(t.changes[e]).length||delete t.changes[e]}function b0(){t.changes={}}async function h0(){t.loading=true;const c=[];for(const e in m.value)try{const a=V.value[e],s={};for(const o in m.value[e])s[o]=m.value[e][o].model,s[o]=B(o,s[o]);console.log("Update row: ",s),await H("set",u.name,a0(a,i.value.primary),s);for(const o in m.value[e])c.push({idx:e,field:o})}catch(a){c0(a,"更新数据失败")}for(const e of c)delete t.changes[e.idx][e.field];for(const e in t.changes)Object.keys(t.changes[e]).length||delete t.changes[e];await L(),c.length&&W.success(`成功修改 ${c.length} 项数据`),t.loading=false}async function C0({row:c,$index:e}){t.loading=true;try{await H("remove",u.name,a0(c,i.value.primary)),await L(),W.success("成功删除数据")}catch(a){c0(a,"数据删除失败")}t.loading=false}async function y0(){t.loading=true;try{const c=Object.keys(t.newRow).reduce((e,a)=>(t.newRow[a]&&(e[a]=t.newRow[a],e[a]=B(a,e[a])),e),{});console.log("Create row: ",c),await H("create",u.name,c),await L(),W.success("成功添加数据");for(const e in t.newRow)t.newRow[e]=""}catch(c){c0(c,"添加数据失败")}t.loading=false}return(c,e)=>{const a=v("el-button"),s=v("k-icon"),o=v("k-button"),r=v("el-table-column"),z=v("el-popconfirm"),C=v("el-table"),v0=v("el-pagination"),w0=$0("loading");return z0((f(),w("div",T0,[h("div",I0,[h("span",F0,F(c.name)+" "+F(i.value.size?`(${J(g0)(i.value.size)})`:""),1),h("div",J0,[x.value?(f(),w("span",U0,[_(a,{type:"primary",disabled:!Y.value,onClick:h0},{default:p(()=>[U("应用修改")]),_:1},8,["disabled"]),_(a,{type:"danger",onClick:b0},{default:p(()=>[U("取消修改")]),_:1})])):(f(),w("span",A0,"双击单元格修改数据"))])]),_(C,{data:V.value,class:"data-table",style:{width:"100%"},height:"100%",border:true,"cell-class-name":({row:b,column:d,rowIndex:O,columnIndex:R1})=>T({row:b,column:d,$index:O},false)?"cell-changed":"","cell-style":Q,onSortChange:t0,onCellDblclick:K},{default:p(()=>[(f(true),w(S0,null,V0(Object.keys(i.value.fields),b=>(f(),R(r,{sortable:x.value?false:"custom",prop:b,label:b,fixed:i.value.primary.includes(b),resizable:true},{header:p(({column:d})=>[U(F(d.label)+" ",1),h("div",{class:"insertion",onClick:e[1]||(e[1]=e0(()=>{},["stop"]))},[(f(),R(l0(M.value[d.label].is),r0({onClick:e[0]||(e[0]=e0(()=>{},["stop"])),modelValue:t.newRow[d.label],"onUpdate:modelValue":O=>t.newRow[d.label]=O},M.value[d.label].attrs||{},{size:"small"}),null,16,["modelValue","onUpdate:modelValue"]))])]),default:p(d=>[T(d,false)?(f(),R(l0(M.value[d.column.label].is),r0({key:0,ref_for:true,ref_key:"changedCells",ref:N,modelValue:t.changes[d.$index][d.column.label].model,"onUpdate:modelValue":O=>t.changes[d.$index][d.column.label].model=O},M.value[d.column.label].attrs||{},{size:"small"}),{suffix:p(()=>[_(o,{frameless:"",type:"danger",onClick:O=>m0(d)},{default:p(()=>[_(s,{name:"times-full"})]),_:2},1032,["onClick"])]),_:2},1040,["modelValue","onUpdate:modelValue"])):(f(),w("div",{key:1,onParentDblclick:O=>_0(d),class:"inner-cell"},F($(b,d)),41,E0))]),_:2},1032,["sortable","prop","label","fixed"]))),256)),_(r,{label:"操作",width:"60",fixed:"right",align:"center"},{header:p(({column:b})=>[U(F(b.label)+" ",1),h("div",{class:"insertion",onClick:e[2]||(e[2]=e0(()=>{},["stop"]))},[_(o,{frameless:"",disabled:!X.value||x.value,onClick:y0},{default:p(()=>[U("插入")]),_:1},8,["disabled"])])]),default:p(b=>[_(z,{onConfirm:d=>C0(b),title:"真的要删除这条数据吗？","confirm-button-text":"是","cancel-button-text":"否"},{reference:p(()=>[_(o,{frameless:"",type:"danger",disabled:x.value},{default:p(()=>[_(s,{name:"times-full"})]),_:1},8,["disabled"])]),_:2},1032,["onConfirm"])]),_:1})]),_:1},8,["data","cell-class-name"]),_(v0,{layout:"total, sizes, prev, pager, next, jumper",small:true,total:i.value.count,"page-sizes":y,"default-page-size":y[0],"page-size":t.pageSize,"onUpdate:pageSize":e[3]||(e[3]=b=>t.pageSize=b),"default-current-page":1,"current-page":g.value,"onUpdate:currentPage":e[4]||(e[4]=b=>g.value=b),disabled:x.value},null,8,["total","default-page-size","page-size","current-page","disabled"])])),[[w0,t.loading]])}}});const j=(n,l)=>{const t=n.__vccOpts||n;for(const[y,u]of l)t[y]=u;return t},H0=j(N0,[["__scopeId","data-v-85788d54"]]),P0={key:0},Q0=h("div",null,"在左侧选择要访问的数据表",-1),q0=f0({__name:"index",setup(n){var Q;function l(g){return Array.isArray(g)?g.join("/"):g||""}const t=P(),y=R0(),u=d0(),i=P(false),N=k(()=>i.value?"filter-off":"filter-on"),V=P(((Q=u.value.dataview)==null?void 0:Q.color)??false),L=k(()=>V.value?"rgb-off":"rgb-on"),D=k({get(){const g=l(y.params.name);return I.database.tables[g]?g:""},set(g){I.database.tables[g]||(g=""),x0.replace("/database/"+g)}}),G=Z(t,g=>(g==null?void 0:g.sendQuery("stats"))&&G());return(g,m)=>{const x=v("k-icon"),Y=v("k-tab-group"),X=v("el-scrollbar"),M=v("k-empty"),t0=v("k-layout");return f(),R(t0,{class:"page-database"},{header:p(()=>{var $;return[U(" 数据库 "),($=J(I).database)!=null&&$.size?(f(),w("span",P0,"("+F(J(g0)(J(I).database.size))+")",1)):L0("v-if",true)]}),menu:p(()=>[h("span",{class:"menu-item",onClick:m[0]||(m[0]=$=>V.value=!V.value)},[_(x,{class:"menu-icon",name:L.value},null,8,["name"])]),h("span",{class:"menu-item",onClick:m[1]||(m[1]=$=>i.value=!i.value)},[_(x,{class:"menu-icon",name:N.value},null,8,["name"])]),h("span",{class:"menu-item",onClick:m[2]||(m[2]=$=>{var q,B;return(B=(q=t.value)==null?void 0:q.updateData())==null?void 0:B.then(()=>{var T,K;return(((T=J(u).dataview)==null?void 0:T.autoStats)??true)&&((K=t.value)==null?void 0:K.sendQuery("stats"))})})},[_(x,{class:"menu-icon",name:"refresh"})])]),left:p(()=>[_(X,null,{default:p(()=>[_(Y,{data:J(I).database.tables,modelValue:D.value,"onUpdate:modelValue":m[3]||(m[3]=$=>D.value=$)},null,8,["data","modelValue"])]),_:1})]),default:p(()=>[(f(),R(D0,null,[D.value?(f(),R(H0,{key:D.value,name:D.value,filter:i.value,color:V.value,ref_key:"table",ref:t},null,8,["name","filter","color"])):(f(),R(M,{key:0},{default:p(()=>[Q0]),_:1}))],1024))]),_:1})}}});const K0={},W0={class:"k-icon",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512"},Z0=h("path",{fill:"currentColor",d:"M224 512C100.3 512 0 476.2 0 432V80C0 35.82 100.3 0 224 0C347.7 0 448 35.82 448 80V432C448 476.2 347.7 512 224 512zM416 80.45C415.7 79.69 414.4 77.27 409.8 73.31C402.4 67.11 389.9 60.09 371.6 53.57C335.4 40.62 283.2 32 224 32C164.8 32 112.6 40.62 76.37 53.57C58.1 60.09 45.59 67.11 38.25 73.31C33.55 77.27 32.29 79.69 32 80.45V182.1C46.47 192.7 69.9 202.8 100.9 210.4C135.5 218.9 177.1 224 224 224C270 224 312.5 218.9 347.1 210.4C378.1 202.8 401.5 192.7 416 182.1V80.45zM416 219.5C398.8 228.4 377.9 235.8 354.8 241.5C317.3 250.7 272.2 256 224 256C175.8 256 130.7 250.7 93.22 241.5C70.11 235.8 49.18 228.4 32 219.5V310.1C46.47 320.7 69.9 330.8 100.9 338.4C135.5 346.9 177.1 352 224 352C270 352 312.5 346.9 347.1 338.4C378.1 330.8 401.5 320.7 416 310.1V219.5zM38.25 438.7C45.59 444.9 58.1 451.9 76.37 458.4C112.6 471.4 164.8 480 224 480C283.2 480 335.4 471.4 371.6 458.4C389.9 451.9 402.4 444.9 409.8 438.7C414.4 434.7 415.7 432.3 416 431.6V347.5C398.8 356.4 377.9 363.8 354.8 369.5C317.3 378.7 272.2 384 224 384C175.8 384 130.7 378.7 93.22 369.5C70.11 363.8 49.18 356.4 32 347.5V431.6C32.29 432.3 33.55 434.7 38.25 438.7zM416 431.4C416.1 431.3 416.1 431.3 416.1 431.3L416 431.4zM31.96 431.4C31.94 431.3 31.93 431.3 31.92 431.3L31.96 431.4zM31.96 80.56C31.93 80.65 31.92 80.7 31.92 80.7L31.96 80.56zM416.1 80.7C416.1 80.7 416.1 80.65 416 80.56z"},null,-1),G0=[Z0];function Y0(n,l){return f(),w("svg",W0,G0)}const X0=j(K0,[["render",Y0]]),t1={},e1={class:"k-icon refresh",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512"},c1=h("path",{fill:"currentColor",d:"M496 40v160C496 213.3 485.3 224 472 224h-160C298.8 224 288 213.3 288 200s10.75-24 24-24h100.5C382.8 118.3 322.5 80 256 80C158.1 80 80 158.1 80 256s78.97 176 176 176c41.09 0 81.09-14.47 112.6-40.75c10.16-8.5 25.31-7.156 33.81 3.062c8.5 10.19 7.125 25.31-3.062 33.81c-40.16 33.44-91.17 51.77-143.5 51.77C132.4 479.9 32 379.5 32 256s100.4-223.9 223.9-223.9c79.85 0 152.4 43.46 192.1 109.1V40c0-13.25 10.75-24 24-24S496 26.75 496 40z"},null,-1),n1=[c1];function a1(n,l){return f(),w("svg",e1,n1)}const o1=j(t1,[["render",a1]]),s1={},l1={xmlns:"http://www.w3.org/2000/svg",viewBox:"2 2 20 20"},r1=h("path",{fill:"currentColor",d:"M2.39 1.73L1.11 3L9 10.89V15.87C8.96 16.16 9.06 16.47 9.29 16.7L13.3 20.71C13.69 21.1 14.32 21.1 14.71 20.71C14.94 20.5 15.04 20.18 15 19.88V16.89L20.84 22.73L22.11 21.46L15 14.35V14.34L13 12.35L11 10.34L4.15 3.5L2.39 1.73M6.21 3L8.2 5H16.96L13.11 9.91L15 11.8V10.75L19.79 4.62C20.13 4.19 20.05 3.56 19.62 3.22C19.43 3.08 19.22 3 19 3H6.21M11 12.89L13 14.89V17.58L11 15.58V12.89Z"},null,-1),i1=[r1];function u1(n,l){return f(),w("svg",l1,i1)}const d1=j(s1,[["render",u1]]),f1={},g1={xmlns:"http://www.w3.org/2000/svg",viewBox:"2 2 20 20"},p1=h("path",{fill:"currentColor",d:"M15,19.88C15.04,20.18 14.94,20.5 14.71,20.71C14.32,21.1 13.69,21.1 13.3,20.71L9.29,16.7C9.06,16.47 8.96,16.16 9,15.87V10.75L4.21,4.62C3.87,4.19 3.95,3.56 4.38,3.22C4.57,3.08 4.78,3 5,3V3H19V3C19.22,3 19.43,3.08 19.62,3.22C20.05,3.56 20.13,4.19 19.79,4.62L15,10.75V19.88M7.04,5L11,10.06V15.58L13,17.58V10.05L16.96,5H7.04Z"},null,-1),_1=[p1];function m1(n,l){return f(),w("svg",g1,_1)}const b1=j(f1,[["render",m1]]),h1={},C1={xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512"},y1=O0(`<g><g><path fill="currentColor" d="M256.005,13.477c-84.682,0-153.734,68.227-155.075,152.594c0.535-0.164,1.073-0.318,1.61-0.477
			...
			C409.734,81.704,340.686,13.477,256.005,13.477z"></path></g></g><g><g><path fill="currentColor" d="M436.614,210.342c-0.136,0.588-0.291,1.172-0.433,1.758c-0.163,0.671-0.325,1.341-0.495,2.01
			...
			c26.778,0,53.256-6.96,76.576-20.133c24-13.557,44.018-33.419,57.887-57.44C533.598,347.601,509.03,253.68,436.614,210.342z"></path></g></g><g><g><path fill="currentColor" d="M357.097,188.296c-26.339,0-52.539,6.858-75.519,19.563c0.206,0.192,0.401,0.394,0.605,0.585
			...
			C391.963,191.252,374.736,188.296,357.097,188.296z"></path></g></g><g><g><path fill="currentColor" d="M229.161,477.688c-0.508-0.483-1.014-0.967-1.516-1.455c-0.909-0.886-1.806-1.785-2.696-2.688
			...
			C230.018,478.523,229.594,478.101,229.161,477.688z"></path></g></g><g><g><path fill="currentColor" d="M154.899,188.295c-17.638,0-34.866,2.956-51.358,8.799c8.136,43.599,34.828,81.76,72.749,104.53
			...
			C207.437,195.152,181.237,188.295,154.899,188.295z"></path></g></g><g><g><path fill="currentColor" d="M308.604,346.356c-0.375,0.111-0.751,0.224-1.126,0.333c-1.352,0.392-2.707,0.77-4.067,1.129
