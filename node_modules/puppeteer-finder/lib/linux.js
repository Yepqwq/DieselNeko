...
function findChromeExecutablesForLinuxDesktop(folder) {
    ...
    if ((0, utils_1.canAccess)(folder)) {
        ...
        let execPaths;
        execPaths = (0, child_process_1.execSync)(`find "${folder}" -type f -exec grep -E "${chromeExecRegex}" "{}" \\; | awk -F '=' '{print $2}'`);
        execPaths = execPaths
            .toString()
...
function linux() {
    ...
    const desktopInstallationFolders = [
        (0, path_1.join)((0, os_1.homedir)(), '.local/share/applications/'),
    ...
    executables.forEach((executable) => {
        ...
        const validChromePaths = [
            ...
            try {
                ...
                if ((0, fs_1.existsSync)(chromePathToTest) && (0, utils_1.canAccess)(chromePathToTest) && (0, utils_1.isExecutable)(chromePathToTest)) {
        ...
        try {
            const chromePath = (0, child_process_1.execFileSync)('which', [executable], {
                stdio: [null, 'pipe', null]
            }).toString().split(utils_1.newLineRegex)[0];
    ...
    return (0, utils_1.sort)(Array.from(new Set(installations.filter(Boolean))), priorities);
}
