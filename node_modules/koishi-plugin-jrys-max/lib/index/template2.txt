<!--
 *抄的Twiyin0的贝拉bot签到和Omega Miya的签到
-->
...
<head>
    ...
    @font-face {
        ...
        .jryslucky p {
            ...
            padding-left: 24px; /* 左内边距为24像素 */
            padding-right: 24px; /* 右内边距为24像素 */
        }
        .header p {
            margin: 0px 0 0;
            color: #666;
...
<body id="body">
    <div class="container">
        ...
        <div class="content">
            <p>@##user## ##signinText##</p>
            <div class="status">
                <p>获得好感度:##todayExp##<br>当前好感度:##totalExp##<br>获得硬币数:##coins##<br>获得经验数:##exp##</p>
            </div>
            ...
            <div class="userfortune"><strong>宜</strong></div>
                <p>##gooddo##</p>
            <div class="userfortune"><strong>不宜</strong></div>
                <p>##baddo##</p>
        </div>
        <div class="credit">
            随机生成 请勿迷信<br> AXLMLY © 2024
        </div>
    </div>
</body>
</html>
