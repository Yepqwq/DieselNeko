...
declare abstract class Jimp extends Service {
     ...
     * @param path 路径
     */
    abstract read(path: string, cb?: (err: any, img: Jm) => void): Promise<Jm>;
    abstract read(data: Buffer, cb?: (err: any, img: Jm) => void): Promise<Jm>;
    abstract read(image: Jimp, cb?: (err: any, img: Jm) => void): Promise<Jm>;
    abstract read(width: number, height: number, background?: number, cb?: (err: any, img: Jm) => void): Promise<Jm>;
    /**
     * 加载字体
     * @param file 字体路径
     */
